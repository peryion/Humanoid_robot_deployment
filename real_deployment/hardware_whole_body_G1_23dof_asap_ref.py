...
HUMANOID_XML = "/home/zhipy/project/unitree/g1_sim2real/ASAP/humanoidverse/data/robots/g1/g1_29dof_anneal_23dof copy.xml"
DEBUG = False
SIM = False
...
class DeployNode(Node):
    ...
    def __init__(self,task='stand'):
        ...
        self.motion_config = OmegaConf.load("/home/zhipy/project/unitree/g1_sim2real/ASAP/g1.yaml")
        # init policy
        self.init_policy()
